...
public class StationShowingActivity extends AppCompatActivity implements StationAdapter.StationClickListerner {
    ...
    private static final String URLTOCALL = "https://crowd-tracking.herokuapp.com/api/beststations";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i =0;i<dataArray.length();i++){
                                ...
                                //Log.v("fdf",String.valueOf(data.getInt(Constants.POPULATION_LEVEL)));
