...
import in.internity.crowdtracker.Activities.StationShowingActivity;
...
public class StationAdapter extends RecyclerView.Adapter<StationAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (mdatamodel != null)
        {
            ...
            holder.populationdensity.setText(String.valueOf(mdatamodel.getPopLevel()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.population_density_count)
        TextView populationdensity;
